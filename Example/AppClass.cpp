...
void AppClass::Update(void)
{
	...
	static float fPercentage = MapValue(fRunTime, 0.0, 10.0, 0.0, 1.0);
	
	
	vector3 v3Interpolation = glm::lerp(v3Start, v3End, static_cast<float>(fPercentage));
